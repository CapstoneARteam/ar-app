...
export default class EditModule extends Component {
    ...
    /**
     * Form to fill out module title, description, and public/private status
     * @return {JSX.Element}
     */
    module_form() {
        return (
    ...
    /**
     * Creates the list of pins based on state.pins. Uses the react-movable library to make the list of pins draggable.
     * @return {JSX.Element}
     */
    list_pins() {
        return (
    ...
    /**
     * Converts state.pins to a list of ObjectIDs, then updates state.module_info.pins based on the new list
     */
    save_pin_order() {
